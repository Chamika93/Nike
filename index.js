...
gsap.from(".dots", { opacity: 0, duration: 1, delay: 2.2, y: 510 });
gsap.from(".shoe-info", { opacity: 0, duration: 1, delay: 2.5, y: -50 });
gsap.from(".size", { opacity: 0, duration: 1, delay: 3, y: -100 });
gsap.from(".count", { opacity: 0, duration: 1, delay: 3, y: 100 });
